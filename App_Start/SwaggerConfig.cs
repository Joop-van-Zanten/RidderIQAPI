	...
	public class SwaggerConfig
	{
		...
		public static void Register()
		{
			...
			GlobalConfiguration.Configuration
				.EnableSwagger(c =>
				{
					...
					//
					c.SingleApiVersion("v1", "RidderIQAPI");
					...
					{
						var attribute = apiDesc.GetControllerAndActionAttributes<Attributes.SwaggerControllerNameAttribute>();
						if (attribute.Any())
						{
		...
		public class DocumentFilter : IDocumentFilter
		{
			...
			public void Apply(SwaggerDocument swaggerDoc, SchemaRegistry schemaRegistry, System.Web.Http.Description.IApiExplorer apiExplorer)
			{
				...
				swaggerDoc.paths = swaggerDoc.paths.OrderBy(e => e.Key).ToList().ToDictionary(e => e.Key + "/", e => e.Value);
			}
		}
	}
}