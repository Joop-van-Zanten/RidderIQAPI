...
{
	/// <summary>
	/// Ridder permission table result
	/// </summary>
	public class TableResult
	{
		/// <summary>
		/// Ridder permission table result constructor
		/// </summary>
		...
		public TableResult(string tableName, bool insert, bool read, bool write, bool delete)
		{
			TableName = tableName;
			Insert = insert;
			Read = read;
